...
function generate() {
	...
	if((($items_length>=$PGITMS&&!$quat)||$quatcount>$PGITMS)&&$PGITMS!=0) {
		...
		if($page==1) {
			$pagination = "<b>1</b> <a href='?page=2".$urlcatsuffix."'>2</a> <a href='?page=".($pgs).$urlcatsuffix."'>Letzte &gt;</a>";
		}
		else if($page<$pgs) {
			$pagination = "<a href='?page=1".$urlcatsuffix."'>&lt; Erste</a> <a href='?page=".($page-1).$urlcatsuffix."'>".($page-1)."</a> <b>".$page."</b> <a href='?page=".($page+1).$urlcatsuffix."'>".($page+1)."</a> <a href='?page=".($pgs).$urlcatsuffix."'>Letzte &gt;</a>";
		}
		else if($page==$pgs) {
			$pagination = "<a href='?page=1".$urlcatsuffix."'>&lt; Erste</a> <a href='?page=".($page-1).$urlcatsuffix."'>".($page-1)."</a> <b>".$page."</b>";
		}
	}
